...
def download_article_worker(post_link, session, output_dir):
    """
...
def download_all_articles_parallel(max_workers=10, a2z_path=None, output_dir=None):
    """
    ...
    if not all_links:
        print(f"No article links found in {a2z_path}.")
        return
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        ...
        future_to_link = {executor.submit(download_article_worker, link, session, output_dir): link for link in all_links}
